...
The image also contains [cloud_sql_proxy](https://github.com/GoogleCloudPlatform/cloudsql-proxy), [gnupg](https://pkgs.alpinelinux.org/package/v3.3/main/x86/gnupg), [mysql-client](https://pkgs.alpinelinux.org/package/edge/main/x86/mysql-client) and [yq](https://github.com/mikefarah/yq).
