...
The image also contains [cloud_sql_proxy](https://cloud.google.com/sql/docs/mysql/sql-proxy), [mysql-client](https://pkgs.alpinelinux.org/package/edge/main/x86/mysql-client) and [yq](https://github.com/mikefarah/yq).
